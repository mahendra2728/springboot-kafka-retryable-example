package com.pm.kafka.config;

import com.pm.kafka.model.UserDetails;
import com.pm.kafka.serializer.UserDetailsDeserializer;
import com.pm.kafka.serializer.UserDetailsSerializer;
...
public class KafkaProducerConfig {
    ...
    public ProducerFactory<String, UserDetails> producerFactory() {
        ...
        configProps.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, UserDetailsSerializer.class.getName());
    ...
    public ConsumerFactory<String, UserDetails> consumerFactory() {
        ...
        deserializer.addTrustedPackages("*"); // or restrict to your packages
        Map<String, Object> props = new HashMap<>();
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapServers);
        props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, UserDetailsDeserializer.class.getName());
